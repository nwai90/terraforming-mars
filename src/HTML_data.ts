...
[CardName.CAPITAL,`
        ...
        <div class="content ">
            ...
            <div class="description " style="text-align:left;">
                ...
                <div style="font-size:12px;margin-top:10px; width: 140px;">
...
[CardName.SMALL_ANIMALS,`
      ...
      <div class="content hover-hide-res">
        ...
        <div class="description" style="text-align:left;">
          ...
          <div style="width: 130px;">Decrease any Plant production 1 step. 1 VP per 2 Animals on this card.</div>
        </div>
      </div>
`],
...
[CardName.OPEN_CITY,`
      ...
      <div class="card-number">108</div>
        <div class="content ">
            ...
            <div class="tile city-tile " style="margin-left:20px;margin-bottom:5px;top: -30px;"></div><br>
            <div style="margin-left: 90px;margin-top: -30px;"><div class="plant resource "></div><div class="plant resource "></div></div>
            <div class="description " style="margin-top:-4px;font-size:11px;text-align: left">
...
[CardName.HERBIVORES,`
        ...
        <div class="content hover-hide-res">
            ...
            <div class="description" style="position:absolute;text-align:left;margin-top:-55px; margin-left: -5px;width: 110px;">
...
[CardName.IMPORTED_NITROGEN,`
      ...
      <div class="card-number">163</div>
          <div class="content ">
            <div class="rating tile" style="margin-left:0px;"></div> 4<div class="plant resource"></div> 3<div class="microbe resource"></div>* 2<div class="animal resource"></div>*
              <div class="description ">
...
[CardName.AEROBRAKED_AMMONIA_ASTEROID,`
          <div class="title background-color-events " style="font-size:13px">Aerobraked Ammonia Asteroid</div>
          <div class="price ">26</div>
          <div class="tag tag1 tag-event "></div>
          <div class="tag tag2 tag-space "></div>
...
[CardName.ATMOSCOOP,`
      ...
      <div class="card-number">217</div>
            <div class="content ">
              ...
              <div class="requirements">3 Science</div>
              <div class="nowrap">
                <div class="tile temperature-tile" style="transform: scale(0.8); margin: 0 -8px"></div>
                <div class="tile temperature-tile" style="transform: scale(0.8); margin: 0"></div>
                 OR
                <div class="tile venus-tile" style="transform: scale(0.8); margin: 0 -2px 0 0">V</div>
                <div class="tile venus-tile" style="transform: scale(0.8); margin: 0 -4px">V</div>
              </div>
              <div class="resource floater" style="margin-top: 10px; margin-bottom: 15px"></div><div class="resource floater"></div><span>*</span>
...
[CardName.FREYJA_BIODOMES,`
            ...
            <div class="content ">
              <div class="points points-big">2</div>
               ...
               <div class="resource microbe"><div class="card-icon tag-venus" style="top:0px;"></div></div> <div class="resource microbe"><div class="card-icon tag-venus" style="top:0px;"></div></div>
              &nbsp;&nbsp;  OR &nbsp;&nbsp;
               <div class="resource animal"><div class="card-icon tag-venus" style="top:0px;"></div></div> <div class="resource animal"><div class="card-icon tag-venus" style="top:0px;"></div></div>
               <div class="production-box production-box-size1a" style="margin-left:135px;">
                   <div class="production-prefix">&#x2796;&#xFE0E;</div><div class="energy production"></div>
                   <div class="production-prefix">&#x2795;&#xFE0E;</div><div class="money production">2</div>
               </div>
               <div class="description" style="position:absolute;margin-top:-80px;margin-left:10px;text-align:left; width: 120px">
...
[CardName.MAXWELL_BASE,`
            ...
            <div class="content ">
              ...
              <div class="tile city-tile" style="margin-left:20px"></div>*
              <div class="description" style="text-align:left;margin-top:-3px; width: 223px">
...
[CardName.STRATOPOLIS,`
            ...
            <div class="content hover-hide-res">
              ...
              <div class="requirements" style="margin-bottom:15px;">2 Science</div>
                ...
                <div class="resource floater"><div class="card-icon card-icon-venus">V</div></div>
                <div class="description " style="margin-top:-5px;margin-left:-15px;width:250px">
              ...
              &nbsp;<div class="tile city-tile"></div>*
                <div class="description " style="text-align:left;margin-top:-58px; width: 92px; margin-left: -5px">
                  Requires 2 science tags. Increase your MC production 2 steps.
                </div>
                <div class="description" style="text-align:left; width: 140px; margin-left: -5px;">
                  Place a City tile ON THE RESERVED AREA. 1 VP per 3 Floaters on this card.
                </div>
            </div>
`],
...
[CardName.VENUSIAN_PLANTS,`
            ...
            <div class="content ">
              ...
              <div class="tile venus-tile" style="margin-bottom:15px;">V</div>
              <br><div class="microbe resource"><div class="card-icon tag-venus" style="margin-top:-40px;"></div></div> OR
              <div class="animal resource"><div class="card-icon tag-venus" style="margin-top:-40px;"></div></div>
              <div class="description">
...
[CardName.JOVIAN_LANTERNS,`
            ...
            <div class="content ">
                ...
                <div class="description " style="margin-top:-5px;text-align:left;">
                  <span>(Requires 1 Jovian tag. Increase your TR 1 step. Add 2 floaters to ANY<br>card. 1VP per 2 floaters.)</span>
                </div>
              </div>
`],
...
[CardName.RED_SPOT_OBSERVATORY,`
            ...
            <div class="content hover-hide-res">
                ...
                <div class="resource card" style="transform:scale(0.9); margin-left:-5px"></div>
                <div class="resource card" style="transform:scale(0.9); margin-left:-5px"></div>
...
[CardName.SUBZERO_SALT_FISH,`
            ...
            <div class="content hover-hide-res">
              ...
              <div class="description" style="text-align:left; width:130px;">
...
[CardName.TITAN_FLOATER_LAUNCHPAD,`
            <div class="title background-color-active" style="font-size:15px;">Titan Floating Launch-Pad</div>
            <div class="price ">18</div>
            <div class="tag tag1 tag-jovian "></div>
            <div class="colonies-icon project-icon"></div>
...
[CardName.PLAYWRIGHTS,`
      ...
      <div class="contentCorporation">
        <div class="corporationEffectBox">
          ...
          <div class="red-arrow"></div>
          REPLAY &nbsp;<div class="resource card red-outline"><div class="card-icon card-icon-event" style="margin-top: -20px; margin-left: 20px"></div></div>&nbsp;*
...
[CardName.MIDAS,`
      ...
      <div class="resource money">150</div>
      <span class="start-tr-text">-9&nbsp;</span>
      <div class="tile rating"></div>

      <div class="description">
        (You start with 150 MC. Lower your TR 9 steps.)
      </div>
`],
