    ...
    super({
      ...
      metadata: {
        ...
        renderData: CardRenderer.builder((b) => {
          ...
          b.text('play', Size.MEDIUM, true).cards(1).colon();
          b.floaters(4).digit;
        }),
        description: 'Gain 6 M€. Play a card from your hand and add 4 floaters to it.',
      },
    });
  }
      ...
      return new SelectHowToPayForProjectCard(
        ...
        (selectedCard, howToPay) => {
          ...
          if (selectedCard.resourceType === ResourceType.FLOATER) {
            player.addResourceTo(selectedCard, {qty: 4, log: true});
          }
          return result;
        },
      );
