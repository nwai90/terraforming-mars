...
export class Hotsprings extends Card implements CorporationCard {
    constructor() {
      super({
        ...
        metadata: {
          cardNumber: 'R48',
          description: 'You start with 45 MC and 5 heat.',
          renderData: CardRenderer.builder((b) => {
            b.br.br.br;
            b.megacredits(45).heat(5);
            b.corpBox('action', (ce) => {
              ce.vSpace();
              ce.action('Increase your MC production 1 step if your heat production was raised 1 step this generation, or 2 steps if it was raised more than 1 step this generation', (eb) => {
