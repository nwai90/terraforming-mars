  ...
  methods: {
    getHtmlContent: function(): string {
      ...
      case CardName.HOTSPRINGS:
        return '<div class="card-hotsprings-logo">Hotsprings</div>';
      case CardName.JUNK_VENTURES:
        return '<div class="card-junk-ventures-logo">Junk Ventures</div>';
      case CardName.ARISTARCHUS:
        return '<div class="card-aristarchus-logo">Aristarchus</div>';
      case CardName.LABOUR_UNION:
      ...
      case CardName.MARS_COALITION:
        return '<div class="card-mars-coalition-logo">Mars Coalition</div>';
      }
      return '';
    },
  },
