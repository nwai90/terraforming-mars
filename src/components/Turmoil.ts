...
const AGENDA_HTML: Map<BonusId | PolicyId, string> = new Map();
{
  AGENDA_HTML.set('mb01',
    `<div class = "tooltip tooltip-bottom" data-tooltip="Gain 1 MC for each Building tag">
  ...
  AGENDA_HTML.set('mb02',
    `<div class = "tooltip tooltip-bottom" data-tooltip="Gain 1 MC for each tile ON MARS">
    <div class="resource money party-resource">1</div> /
    <div class="tile empty-tile-small"></div>ON MARS
    </div>`);
  AGENDA_HTML.set('sb01',
    `<div class = "tooltip tooltip-bottom" data-tooltip="Gain 1 MC for each Science tag">
    <div class="resource money party-resource">1</div> /
    <div class="resource-tag tag-science party-resource-tag"></div>
    </div>`);
  AGENDA_HTML.set('sb02',
    `<div class = "tooltip tooltip-bottom" data-tooltip="Gain 1 MC for every 3 cards in hand">
    <div class="resource money party-resource">1</div> / 3
    <div class="resource card card-small"></div>
    </div>`);
  AGENDA_HTML.set('ub01',
    `<div class = "tooltip tooltip-bottom" data-tooltip="Gain 1 MC for each Venus, Earth and Jovian tag">
    <div class="resource money party-resource">1</div> /
  ...
  AGENDA_HTML.set('ub02',
    `<div class = "tooltip tooltip-bottom" data-tooltip="Gain 1 MC for each Space tag">
    <div class="resource money party-resource">1</div> /
    <div class="resource-tag tag-space party-resource-tag"></div>
    </div>`);
  AGENDA_HTML.set('kb01',
    `<div class = "tooltip tooltip-bottom" data-tooltip="Gain 1 MC for each Heat production">
    <div class="resource money party-resource">1</div> /
  ...
  AGENDA_HTML.set('gb01',
    `<div class = "tooltip tooltip-bottom" data-tooltip="Gain 1 MC for each Plant, Microbe and Animal tag">
    <div class="resource money party-resource">1</div> /
  ...
  AGENDA_HTML.set('gb02',
    `<div class = "tooltip tooltip-bottom" data-tooltip="Gain 2 MC for each Greenery tile">
  ...
  AGENDA_HTML.set('mfp02',
    ...
    <div class="bonus-text">When you play a Building tag, gain 2 MC</div>`);
  AGENDA_HTML.set('mfp03',
    `<div class="policy-top-margin"><div class="resource steel"></div> : +<div class="resource money">1</div></div>
    <div class="bonus-text">Your steel resources are worth 1 MC extra</div>`);
  AGENDA_HTML.set('mfp04',
    ...
    <div class="bonus-text">Spend 4 MC to draw a Building card</div>`);
  AGENDA_HTML.set('sp01',
    ...
    <span class="card card-with-border resource party-resource"></span>
    <span class="card card-with-border resource party-resource"></span>
    <div class="bonus-text">Pay 10 MC to draw 3 cards</div>`);
  ...
  AGENDA_HTML.set('up01',
    ...
    <div class="bonus-text">Your titanium resources are worth 1 MC extra</div>`);
  AGENDA_HTML.set('up02',
    ...
    <div class="bonus-text">Spend 4 MC to gain 2 titanium or add 2 floaters to any card</div>`);
  ...
  AGENDA_HTML.set('rp01',
    ...
    <div class="bonus-text">When you take an action that raises TR, pay 3 MC per step raised</div>`);
  AGENDA_HTML.set('rp02',
    `<div class="policy-top-margin"><div class="tile empty-tile-small"></div> : <span class="money resource">-3</span></div>
    <div class="bonus-text">When you place a tile, pay 3 MC or as much as possible</div>`);
  AGENDA_HTML.set('rp03',
    ...
    <div class="bonus-text">Pay 4 MC to reduce a non-maxed global parameter 1 step (do not gain any track bonuses)</div>`);
  AGENDA_HTML.set('rp04',
    ...
    <div class="bonus-text">When you raise a global parameter, decrease your MC production 1 step per step raised if possible</div>`);
  AGENDA_HTML.set('gp01',
    `<div class="tile greenery-tile"></div> : <div class="resource money">4</div>
    <div class="bonus-text">When you place a greenery tile, gain 4 MC</div>`);
  ...
  AGENDA_HTML.set('gp03',
    ...
    <div class="bonus-text">When you play an animal, plant or microbe tag, gain 2 MC</div>`);
  AGENDA_HTML.set('gp04',
    ...
    <div class="bonus-text">Spend 5 MC to gain 3 plants or add 2 microbes to any card</div>`);
  AGENDA_HTML.set('spb01',
    `<div class = "tooltip tooltip-bottom" data-tooltip="Gain 1 MC for each different tag">
  ...
  AGENDA_HTML.set('spb02',
    `<div class = "tooltip tooltip-bottom" data-tooltip="Gain 1 MC for each different resource type">
  ...
  AGENDA_HTML.set('spp01',
    ...
    <div class="bonus-text">When you raise Venus, gain 2 MC per step raised</div>`);
  AGENDA_HTML.set('spp02',
    ...
    <div class="bonus-text">Pay 10 MC to gain a trade fleet</div>`);
  ...
  AGENDA_HTML.set('spp04',
    ...
    <div class="bonus-text">Pay 10 MC to draw 2 planetary cards</div>
    `);
  AGENDA_HTML.set('eb01',
    `<div class = "tooltip tooltip-bottom" data-tooltip="Gain 2 MC for each Power tag">
  ...
  AGENDA_HTML.set('eb02',
    `<div class = "tooltip tooltip-bottom" data-tooltip="Gain 1 MC for each Energy production">
    <div class="resource money party-resource">1</div> /
    <div class="production-box party-production-box">
        <div class="energy production"></div>
    </div>
  ...
  AGENDA_HTML.set('ep01',
    ...
    <div class="bonus-text">Spend X MC to gain X energy</div>`);
  ...
  AGENDA_HTML.set('ep04',
    ...
    <div class="bonus-text">When you play a Power tag, you pay 3 MC less for it</div>`);
  AGENDA_HTML.set('pb01',
    `<div class = "tooltip tooltip-bottom" data-tooltip="Lose 1 MC for every 5 MC over 40">
    <div class="resource money party-resource">-1</div> / <div class="resource money party-resource">5</div> over 40
    </div>`);
  AGENDA_HTML.set('pb02',
    `<div class = "tooltip tooltip-bottom" data-tooltip="Lose 2 MC for every 8 cards in hand">
  ...
  AGENDA_HTML.set('pp02',
    ...
    <div class="bonus-text">When you play a card with NON-NEGATIVE VP, lose 2 MC or as much as possible</div>`);
  ...
  AGENDA_HTML.set('pp04',
    ...
    <div class="bonus-text">When you place a tile, gain 3 MC</div>`);
  AGENDA_HTML.set('bb01',
    `<div class = "tooltip tooltip-bottom" data-tooltip="Gain 1 MC for each event played">
    <div class="resource money party-resource">1</div> /
  ...
  AGENDA_HTML.set('bp03',
    ...
    <div class="bonus-text">Pay 3 MC to place your player marker on a non-reserved area</div>`);
  AGENDA_HTML.set('bp04',
    `<div class="policy-top-margin"><div class="resource-tag tag-earth"></div> : <div class="money resource">-3</div></div>
    <div class="bonus-text">When you play an Earth tag, you pay 3 MC less for it</div>`);
  AGENDA_HTML.set('tb01',
    `<div class = "tooltip tooltip-bottom" data-tooltip="Gain 1 MC for each card with requirements played">
  ...
  AGENDA_HTML.set('tb02',
    `<div class = "tooltip tooltip-bottom" data-tooltip="Gain 2 MC for each card with no tags played">
  ...
  AGENDA_HTML.set('tp02',
    ...
    <div class="bonus-text">Spend 10 MC to gain 1 influence</div>`);
  AGENDA_HTML.set('tp03',
    ...
    <div class="bonus-text">Spend 10 MC to play a card from hand, ignoring global requirements</div>`);
  ...
  AGENDA_HTML.set('cb01', `
    <div class = "tooltip tooltip-bottom" data-tooltip="Gain 8 MC">
  ...
  AGENDA_HTML.set('cp01',
    ...
    <div class="bonus-text">Gain 6 MC</div>`);
  AGENDA_HTML.set('cp02',
    `<div class="policy-top-margin">
    <div class="delegate"></div> : <span class="money resource">+2</span>
    </div>
    <div class="bonus-text">Delegates cost 2 MC more to place</div>`);
  AGENDA_HTML.set('cp03',
    `<div class="policy-top-margin">
    <span class="red-arrow"></span>
    <div class="trade"></div>
    </div>
    <div class="bonus-text">Trade with any colony tile for free</div>`);
  AGENDA_HTML.set('cp04',
    `<div class="policy-top-margin"><div class="resource-tag tag-event"></div> : <div class="money resource">-2</div></div>
    <div class="bonus-text">When you play an Event card, you pay 2 MC less for it</div>`);
}
