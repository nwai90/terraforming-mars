...
export class Reds extends Party implements IParty {
  ...
  policies = [REDS_DEFAULT_POLICY, REDS_POLICY_2, REDS_POLICY_3, REDS_POLICY_4];
}
...
class RedsPolicy01 implements Policy {
  ...
  isDefault = true;
  description: string = 'When you take an action that raises TR, pay 3 MC per step raised';
}
...
export const REDS_DEFAULT_POLICY = new RedsPolicy01();
